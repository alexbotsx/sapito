...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '595984303784-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝗚𝗛𝗢𝗦𝗧 𝗕𝗢𝗧', 'jpegThumbnail': null } } };
